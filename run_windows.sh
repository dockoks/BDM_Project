...
python -c 'from temporal_landing.temporal_loader_windows import upload_avro_to_hdfs; upload_avro_to_hdfs("'"$AVRO_DATA_PATH"'", "'"$HDFS_USER"'", "'"$HDFS_PASSWORD"'", "'"$HDFS_IP"'", "'"$HDFS_PORT"'", "'"$HDFS_AVRO_PATH"'")'
